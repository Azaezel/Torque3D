   ...
   const MaterialFeatureData& fd)
{
   ...
   if (ibl && color)
   {
      ...
      meta->addStatement(new GenOp(computeForwardProbes.c_str(), ibl, surface, cubeMips, numProbes, worldToObjArray, probeConfigData, inProbePosArray, refBoxScale, inRefPosArray,
